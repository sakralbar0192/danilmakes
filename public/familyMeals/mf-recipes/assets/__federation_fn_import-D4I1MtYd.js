...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-BzKvbPDO.js', import.meta.url).href),import:true,requiredVersion:'^3.4.0'},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-BFEvziUf.js', import.meta.url).href),import:true,requiredVersion:'^4.4.0'},'@meal/shell-chrome':{get:()=>()=>__federation_import(new URL('__federation_shared_@meal/shell-chrome-YgTXEoVr.js', import.meta.url).href),import:true,requiredVersion:'0.0.1'}};
