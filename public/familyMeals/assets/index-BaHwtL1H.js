import { g as getRawSetCookie, c as cookieStore, i as invariant$1, d as devUtils, a as createRequestId$1, t as toPublicUrl, I as InternalError, b as Interceptor$1, B as BatchInterceptor, R as RequestHandler, H as HttpResponse } from './cookieStore-D-ixA_Tn.js';

//#region src/lens-list.ts
var LensList$1 = class LensList {
	#list;
	#lens;
	constructor() {
		this.#list = [];
...
//#region src/index.ts
const kDefaultPrevented$2 = Symbol("kDefaultPrevented");
const kPropagationStopped$1 = Symbol("kPropagationStopped");
const kImmediatePropagationStopped$1 = Symbol("kImmediatePropagationStopped");
var TypedEvent$1 = class TypedEvent extends MessageEvent {
	/**
...
class NetworkFrameEvent extends TypedEvent$1 {
  frame;
...
var DeferredPromise$1 = class DeferredPromise extends Promise {
  #executor;
  resolve;
  reject;
...
class RequestEvent extends TypedEvent$1 {
  requestId;
  request;
...
class ResponseEvent extends TypedEvent$1 {
  requestId;
  request;
  response;
  constructor(type, data) {
...
class UnhandledExceptionEvent extends TypedEvent$1 {
  error;
  requestId;
  request;
  constructor(type, data) {
...
const kCancelable$1 = Symbol("kCancelable");
const kDefaultPrevented$1 = Symbol("kDefaultPrevented");
/**
...
*/
var CancelableMessageEvent$1 = class CancelableMessageEvent extends MessageEvent {
...
var CloseEvent$1 = class CloseEvent extends Event {
	constructor(type, init = {}) {
		super(type, init);
...
var CancelableCloseEvent$1 = class CancelableCloseEvent extends CloseEvent$1 {
	constructor(type, init = {}) {
		super(type, init);
		this[kCancelable$1] = !!init.cancelable;
		this[kDefaultPrevented$1] = false;
...
const kEmitter$1$1 = Symbol("kEmitter");
const kBoundListener$1$1 = Symbol("kBoundListener");
/**
* The WebSocket client instance represents an incoming
* client connection. The user can control the connection,
* send and receive events.
*/
var WebSocketClientConnection$1 = class WebSocketClientConnection {
...
const WEBSOCKET_CLOSE_CODE_RANGE_ERROR$1 = "InvalidAccessError: close code out of user configurable range";
const kPassthroughPromise$1 = Symbol("kPassthroughPromise");
const kOnSend$1 = Symbol("kOnSend");
const kClose$1 = Symbol("kClose");
var WebSocketOverride$1 = class WebSocketOverride extends EventTarget {
	static {
		this.CONNECTING = 0;
	}
	static {
...
const kEmitter$2 = Symbol("kEmitter");
const kBoundListener$2 = Symbol("kBoundListener");
const kSend$1 = Symbol("kSend");
/**
* The WebSocket server instance represents the actual production
* WebSocket server connection. It's idle by default but you can
* establish it by calling `server.connect()`.
*/
var WebSocketServerConnection$1 = class WebSocketServerConnection {
...
*/
var WebSocketClassTransport$1 = class WebSocketClassTransport extends EventTarget {
	constructor(socket) {
		super();
		this.socket = socket;
...
class WebSocketConnectionEvent extends TypedEvent$1 {
  url;
  protocols;
  constructor(type, data) {
    super(...[type, {}]);
...
class UnhandledWebSocketExceptionEvent extends TypedEvent$1 {
  url;
  protocols;
  error;
  constructor(type, data) {
