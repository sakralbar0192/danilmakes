...
`},8563(t,e,i){i.d(e,{DivisionsLayer:()=>E});var o=i(6161);const n=o.AH`div{display:flex;flex-direction:column;align-items:stretch;width:100%;max-width:1050px;min-width:0;margin:auto;box-sizing:border-box}:host{display:block;width:100%;max-width:100%;min-width:0}div divisions-table{margin:0 0 20px;min-width:0;max-width:100%}div iceberg-button{align-self:flex-end}@media(max-width:768px){div{max-width:100%}div iceberg-button{align-self:stretch}}`;var s=i(581),r=i(3757),c=i(7843),a=i(2745),d=i(7771),l=i(6312),p=i(8029),v=i(655),h=i(5073),u=i(9574);function m(t){const e=[],i=`Divisions.aspx?mode=${l.b.divisionDetailsLayer}&division_id=${t.Id}`,n={content:o.qy`
        ...
        `,compareContent:t.Name},s={content:t.UserCount},r={content:t.Managers?o.qy`
            ${t.Managers.map((e,i)=>{const n=(0,u.r)(e.Id,e.Name??"");return t.Managers&&i+1===t.Managers.length?n:o.qy`${n} <br />`})}
        ...
        ${n}
    `,function(t,e,i,o){var n,s=arguments.length,r=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var c=t.length-1;c>=0;c--)(n=t[c])&&(r=(s<3?n(r):s>3?n(e,i,r):n(e,i))||r);s>3&&r&&Object.defineProperty(e,i,r)}([(0,a.MZ)({type:Object,attribute:!1})],E.prototype,"divisions",void 0)},9574(t,e,i){i.d(e,{r:()=>n});var o=i(6752);function n(t,e,i="View user details"){return o.qy`<span class="entity-name">${e}</span>`}},7765(t,e,i){i.d(e,{k:()=>l});var o=i(3757),n=i(7843),s=i(6161);const r=s.AH`div{display:flex;align-items:center;flex-direction:column;justify-content:center;width:100%;height:100%;padding:20px}`;var c=i(2745),a=i(6388);(0,i(581).Rx)();class d extends s.WF{constructor(){super(...arguments),this.errorMessage=a.Rb,this.ADDITIONAL_MESSAGE="Try to reload this page"}render(){return s.qy`
            <div>
