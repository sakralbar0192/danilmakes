...
export interface CaseStudy {
    ...
    portfolioId: string
    title: string
    /** Title for <title> / OG — search-oriented, falls back to title */
    seoTitle?: string
    metaDescription: string
    /** Prompt above the contact CTA on the case page */
    ctaPrompt?: string
    lead: string
    context: string
    challenge: string
...
export const CASE_STUDIES: CaseStudy[] = [
    {
        ...
        title: 'danilmakes.ru',
        seoTitle: 'Сайт-визитка разработчика на React и VPS',
        metaDescription:
            'Как собрать персональный сайт с портфолио, формой заявок и деплоем на VPS: React, Express, PostgreSQL. Кейс danilmakes.ru.',
        ctaPrompt: 'Нужен свой сайт с формой заявок?',
    ...
    },
    {
        ...
        title: 'Студия «Линия»',
        seoTitle: 'Лендинг для салона красоты и барбершопа',
        metaDescription:
            'Пример лендинга для салона, барбершопа и косметолога: услуги, отзывы, онлайн-запись и адаптив. Кейс Студия «Линия».',
        ctaPrompt: 'Нужен лендинг для салона, барбершопа или косметолога?',
    ...
    },
    {
        ...
        seoTitle: 'Сайт для стоматологии с онлайн-записью',
        metaDescription:
            'Лендинг стоматологии: услуги, врачи, акции и форма записи. Пример сайта для клиники — кейс «Дента+».',
        ctaPrompt: 'Нужен сайт для стоматологии или клиники?',
    ...
    },
    {
        ...
        seoTitle: 'Заявки с сайта в Telegram и на почту',
        metaDescription:
            'Как настроить отправку заявок с формы сайта в Telegram и на email через Express API. Кейс интеграции.',
        ctaPrompt: 'Нужны заявки с сайта в Telegram и на почту?',
    ...
    },
    {
        ...
        seoTitle: 'Админка записей для салона красоты',
        metaDescription:
            'Панель заявок для салона: список записей, фильтр по статусу, поиск. Демо админки после онлайн-записи.',
        ctaPrompt: 'Нужна панель записей для вашего бизнеса?',
    ...
    },
    {
        ...
        seoTitle: 'Дашборд выручки и загрузки',
        metaDescription:
            'Аналитический отчёт по доходу: графики выручки, загрузки, ADR и RevPAR. Демо на Vue без backend.',
        ctaPrompt: 'Нужен отчёт или дашборд по метрикам?',
    ...
    },
    {
        ...
        seoTitle: 'Календарь цен и ограничений тарифа',
        metaDescription:
            'Сложный календарный экран управления ценами и ограничениями: виртуальный скролл, inline-редактирование. Vue + MSW.',
        ctaPrompt: 'Нужен сложный интерфейс с таблицами и календарём?',
    ...
    },
    {
        ...
        title: 'Divisions',
        seoTitle: 'Админка оргструктуры на Lit Web Components',
        metaDescription:
            'Модуль подразделений и ресурсных пулов на Lit: CRUD, FSD-архитектура, демо без production API.',
        ctaPrompt: 'Нужен модуль админки на Web Components?',
    ...
    },
    {
        ...
        seoTitle: 'Планировщик питания на микрофронтендах',
        metaDescription:
            'Семейное приложение: рецепты, недельный план и список покупок. Module Federation + Vue — кейс в портфолио.',
        ctaPrompt: 'Нужно приложение со сложной фронтенд-архитектурой?',
    ...
    },
    {
        ...
        seoTitle: 'Telegram-бот для волейбола и тенниса',
        metaDescription:
            'Pet-project: мульти-спорт Telegram-сервис для поиска игр по волейболу и теннису. TypeScript, Prisma, Telegraf.',
        ctaPrompt: 'Нужен Telegram-бот под ваш сервис?',
