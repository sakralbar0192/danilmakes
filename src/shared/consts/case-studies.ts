...
export const CASE_STUDIES: CaseStudy[] = [
    ...
    },
    {
        ...
        metaDescription: 'Кейс: демо панели записей для услуг — фильтр, статусы, синтетические данные.',
        lead: 'Простая админка для салона или мастера: заявки, статусы и поиск — без hotel-жаргона.',
        ...
        challenge: 'Показать типовой CRUD-lite сценарий без backend: фильтрация, смена статуса, мобильная таблица — на понятном языке услуг.',
        solution: 'Статическое демо `public/bookingAdmin/`: таблица записей, фильтр по статусу, поиск, смена статуса в памяти. Синтетические данные салона «Линия».',
        stack: [
            'HTML5',
            'CSS',
            'JavaScript',
