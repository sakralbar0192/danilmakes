...
export default class HotelModel {
  ...
  static PRODUCT_TYPES = {
    [HotelModel.PRODUCT_TYPE_PMS]: "Bnovo PMS",
    [HotelModel.PRODUCT_TYPE_PMS_MODULE]: i18n.t("Bnovo PMS и модуль бронирования"),
  ...
  get hasWaitingListAccess() {
    return store.getters["productTools/isToolAvailable"](ProductToolId.BOOKING_WAITLIST);
  }

  get hasTimeServicesAccess() {
    return store.getters["productTools/isToolAvailable"](ProductToolId.EXTRA_SERVICES_HOURLY);
  }

  get hasPromoCodesAccess() {
    return store.getters["productTools/isToolAvailable"](ProductToolId.PMS_PROMO_CODES);
  }
